...
export type Dictionary = {
  ...
  contests: {
    ...
    entryDescriptionPlaceholder: string;
    filesLabel: string;
    submitEntry: string;
    submitting: string;
    submitSuccess: string;
    entriesTitle: string;
    anonymousEntry: string;
    winnerBadge: string;
  ...
  actionErrors: {
    ...
    ADMIN_ACCOUNT_DEACTIVATED: string;
    ADMIN_INSUFFICIENT_PERMISSION: string;
    ADMIN_STAFF_MANAGE_REQUIRED: string;
    PROJECT_NOT_IN_DISPUTE: string;
    PROJECT_NOT_IN_MODERATION: string;
    CANNOT_CLOSE_ACTIVE_ESCROW: string;
    REPORT_NOT_FOUND: string;
    REPORT_NOT_FOUND_OR_IN_PROGRESS: string;
    ATTENTION_ITEM_NOT_FOUND: string;
    CANNOT_TARGET_SELF: string;
    CANNOT_TARGET_ADMIN: string;
    USER_NOT_BANNED: string;
    PORTFOLIO_ITEM_NOT_FOUND: string;
    AVATAR_NOT_PENDING_REVIEW: string;
    BROADCAST_TITLE_TOO_SHORT: string;
    BROADCAST_BODY_TOO_SHORT: string;
    BROADCAST_TITLE_TOO_LONG: string;
    BROADCAST_BODY_TOO_LONG: string;
    BROADCAST_AUDIENCE_REQUIRED: string;
    BROADCAST_LINK_INVALID: string;
    BROADCAST_CONFIRM_REQUIRED: string;
    BROADCAST_NO_RECIPIENTS: string;
    CATEGORY_NAME_REQUIRED: string;
    SKILL_NAME_REQUIRED: string;
    SKILL_DUPLICATE: string;
    CATEGORY_HAS_PROJECTS: string;
    SKILL_NOT_FOUND: string;
    MIN_BUDGET_POSITIVE_REQUIRED: string;
    BALANCE_ADJUSTMENT_NONZERO: string;
    BALANCE_CANNOT_GO_NEGATIVE: string;
    WITHDRAWAL_NOT_FOUND: string;
    FINE_AMOUNT_POSITIVE: string;
    BAN_DAYS_RANGE: string;
    VERIFICATION_REQUEST_NOT_FOUND: string;
    CMS_SLUG_TITLE_REQUIRED: string;
    CMS_INVALID_LOCALE: string;
    CMS_CONTENT_TOO_SHORT: string;
    ADMIN_EMAIL_INVALID: string;
    ADMIN_NAME_REQUIRED: string;
    ADMIN_PERMISSIONS_REQUIRED: string;
    ADMIN_EMAIL_EXISTS: string;
    ADMIN_NOT_FOUND: string;
    ADMIN_CANNOT_DEACTIVATE_SELF: string;
    ADMIN_CANNOT_REVOKE_OWN_ACCESS: string;
    ADMIN_ALREADY_ACTIVE: string;
    ADMIN_DEACTIVATE_BEFORE_DELETE: string;
    ADMIN_CANNOT_DELETE_SELF: string;
    ADMIN_LAST_SUPERADMIN_REQUIRED: string;
    TICKET_NOT_FOUND: string;
    TICKET_ASSIGNMENT_REQUIRED: string;
    FREELANCER_PROFILE_REQUIRED: string;
    VERIFICATION_ALREADY_PENDING: string;
    VERIFICATION_ALREADY_APPROVED: string;
    SPECIALIZATION_REQUIRED: string;
    PROFILE_BIO_TOO_SHORT: string;
    SKILL_REQUIRED: string;
    WITHDRAWAL_FREELANCERS_ONLY: string;
    WITHDRAWAL_MIN_AMOUNT: string;
    WITHDRAWAL_PENDING_EXISTS: string;
    WITHDRAWAL_INSUFFICIENT_BALANCE: string;
    WITHDRAWAL_PAYOUT_METHOD_REQUIRED: string;
    WITHDRAWAL_PAYOUT_DESTINATION_REQUIRED: string;
    WITHDRAWAL_CARD_INVALID: string;
    WITHDRAWAL_IBAN_INVALID: string;
