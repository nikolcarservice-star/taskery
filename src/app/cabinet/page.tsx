...
export default function AdminCabinetPage() {
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
      <h1 className="text-2xl font-bold text-zinc-900">Кабинет администратора</h1>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        ...
        <AdminModeLink
          mode="freelancer"
          href="/dashboard"
          className="rounded-xl border border-emerald-200 bg-emerald-50 px-5 py-4 transition-colors hover:bg-emerald-100"
        >
